...
// Inline Button Component (self-contained — independent of shadcn's button.tsx)
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl relative pb-20">
        {/* glow — CSS radial gradient instead of a hotlinked png */}
        <div
          className="absolute left-1/2 top-[-23%] w-[90%] h-[60%] -translate-x-1/2 pointer-events-none z-0"
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(120,119,198,0.35), rgba(120,119,198,0.10) 45%, transparent 70%)",
            filter: "blur(40px)"
          }}
          aria-hidden="true"
        />
