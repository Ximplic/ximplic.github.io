  ...
  return (
    <>
      ...
      <section className="relative min-h-[82vh] flex flex-col items-center justify-center px-6 pt-28 pb-20 overflow-hidden">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
          {SHAPES.map((s, i) => (
            <div key={i} className={cn("hero-shape", s.pos)} style={{ ["--r"]: `${s.r}deg`, ["--d"]: `${s.d}s` } as CSSProperties}>
              <div className={cn("hero-shape-inner bg-gradient-to-r to-transparent border-2 border-white/15 backdrop-blur-[2px]", s.grad)} style={{ width: s.w, height: s.h, boxShadow: "0 8px 32px 0 rgba(43,232,165,0.10)" }} />
            </div>
          ))}
        </div>
        ...
        <h1 className="rise text-4xl md:text-6xl lg:text-[68px] font-semibold text-center max-w-4xl leading-[1.05] mb-6" style={{ letterSpacing: "-0.04em", animationDelay: ".08s" }}>
      ...
      <section id="products" className="px-6 py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto rv">
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4 max-w-2xl">Energy-efficient inference IP for the edge</h2>
          ...
          <div className="rvs grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { tag: "Launching now", name: "Vyzora", desc: "The Virtual Prototype. Run any model, measure power, no hardware.", to: "/products/vyzora" },
              ...
              <div key={p.name} className={`rounded-xl border border-white/10 bg-white/[0.02] p-6 flex flex-col transition-colors hover:border-white/20 ${p.to ? "" : "opacity-60"}`}>
                ...
                {p.to
                  ? <Link to={p.to} className="text-sm font-medium mt-4 -my-1 py-1 inline-flex items-center gap-1" style={{ color: TEAL }}>Explore <ArrowRight size={13} /></Link>
      ...
      <section id="why" className="px-6 py-24 border-t border-white/[0.06]">
        <div className="max-w-5xl mx-auto rv">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4 max-w-2xl">Most of the energy moves data, not uses it</h2>
      ...
      <section id="proof" className="px-6 py-24 border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto rv">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-12 max-w-2xl">Proven on real hardware</h2>
      ...
      <section id="contact" className="px-6 py-28 border-t border-white/[0.06]">
        <div className="max-w-2xl mx-auto text-center rv">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tight mb-5" style={{ letterSpacing: "-0.03em" }}>Get Ximplic Vyzora</h2>
